                ...
                if (n > 0)
                {
                    ...
                    if (ev.filter == EVFILT_VNODE)
                    {
                        ...
                        if (ev.fflags)
                        {
                            ...
                            VDKQueuePathEntry *pe = (__bridge VDKQueuePathEntry*)ev.udata;    // In case one of the notified folks removes the path.
                            ...
                            // Need to retain so it does not disappear while the block below is waiting to run on the main thread.
